...
- Prefer SwiftData when it is already established or fits the project's requirements. Recommend Core Data or another store only for a concrete capability, compatibility, or performance gap.
