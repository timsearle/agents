...
Treat the installed toolchain and current official Swift or Apple documentation as authoritative. If examples and the compiler disagree, verify with a minimal compile or test rather than guessing.
